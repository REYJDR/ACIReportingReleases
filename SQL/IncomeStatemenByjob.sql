...
GROUP BY  "Chart"."AccountID" ,AccTypeDescription, "Chart"."AccountType" ,  "Company"."CompanyName", "Chart"."AccountType" , "Chart"."AccountDescription" ,"JrnlRow"."IncludeInGL" , "JrnlRow"."Rowtype", InventoryCosts.RecordType, ADJ.RecordType,jobs.JobRecordNumber, jobs.JobDescription 
...
GROUP BY  "Chart"."AccountID" ,AccTypeDescription, "Chart"."AccountType" ,  "Company"."CompanyName", "Chart"."AccountType" , "Chart"."AccountDescription" ,"JrnlRow"."IncludeInGL" , "JrnlRow"."Rowtype", InventoryCosts.RecordType,jobs.JobRecordNumber, jobs.JobDescription , "JrnlRow"."Journal" ,"InventoryCosts"."OptQty" 